...
//  getSum(1, 2, 3) === 6
//  getSum(1, 2, 3, 4, 5) === 15
export const getSum = (...booger) => {
  return booger.reduce((accumulator, currentValue) => (accumulator += currentValue), 0)
}
...
export const totalSneakerCount = (brands) => {
  const sneakers = []
  for (const brand of Object.keys(brands)) sneakers.push(...brands[brand].shoes)
